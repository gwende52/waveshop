...
# Waveshop
btn-waveshop-release-latest = 👀 Посмотреть
btn-waveshop-how-upgrade = ❓ Как обновить
btn-waveshop-github = ⭐ GitHub
btn-waveshop-telegram = 👪 Telegram
btn-waveshop-donate = 💰 Поддержать разработчика
btn-waveshop-guide = ❓ Инструкция
...
btn-dashboard-waveshop = 🛍 WaveShop
...
# WaveShop
btn-waveshop-admins = 👮‍♂️ Администраторы
btn-waveshop-gateways = 🌐 Платежные системы
btn-waveshop-referral = 👥 Реферальная
btn-waveshop-advertising = 🎯 Реклама
btn-waveshop-plans = 📦 Планы
btn-waveshop-notifications = 🔔 Уведомления
btn-waveshop-logs = 📄 Логи
btn-waveshop-audit = 🔍 Аудит
