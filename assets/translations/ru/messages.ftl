...
ntf-waveshop-info =
    ...
    ⭐ <i>Поставьте звездочку на <a href="https://github.com/snoups/waveshop">GitHub</a> и присоединяйтесь к нашему <a href="https://t.me/@remna_shop">сообществу</a>.</i>
...
# WaveShop
msg-waveshop-main = <b>🛍 WaveShop</b>
