...
ASSETS_CONTAINER_PATH="/opt/waveshop/assets"
ASSETS_DEFAULT_PATH="/opt/waveshop/assets.default"
...
if [ "$UVICORN_RELOAD_ENABLED" = "true" ]; then
    ...
    UVICORN_RELOAD_ARGS="--reload --reload-dir /opt/waveshop/src --reload-dir /opt/waveshop/assets --reload-include *.ftl"
else
