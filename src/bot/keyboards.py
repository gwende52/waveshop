...
def get_waveshop_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()

    builder.row(
        InlineKeyboardButton(
            text="btn-waveshop-github",
            url="https://github.com/snoups/waveshop",
        ),
        InlineKeyboardButton(
            text="btn-waveshop-telegram",
            url="https://t.me/remna_shop",
        ),
        InlineKeyboardButton(
            text="btn-waveshop-guide",
            url="https://t.me/remna_shop",
        ),
    )
...
def get_waveshop_update_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()

    builder.row(
        InlineKeyboardButton(
            text="btn-waveshop-release-latest",
            url="https://github.com/snoups/waveshop/releases/latest",
        ),
        InlineKeyboardButton(
            text="btn-waveshop-how-upgrade",
            url="https://github.com/snoups/waveshop?tab=readme-ov-file#step-5--how-to-upgrade",
        ),
    )
