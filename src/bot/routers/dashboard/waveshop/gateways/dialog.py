...
from src.bot.states import DashboardWaveshop, WaveshopGateways
...
gateways = Window(
    ...
    ListGroup(
        Row(
            Button(
                text=I18nFormat(
                    "btn-gateway-title", gateway_type=F["item"]["gateway_type"]
                ),
                id="select_gateway",
            ...
            Button(
                text=I18nFormat(
                    "btn-gateway-active", is_active=F["item"]["is_active"]
                ),
                id="active_toggle",
    ...
    Row(
        SwitchTo(
            ...
            id="default_currency",
            state=WaveshopGateways.CURRENCY,
        ),
    ),
    Row(
        Start(
...
gateway_settings = Window(
    ...
    IgnoreUpdate(),
    state=WaveshopGateways.SETTINGS,
